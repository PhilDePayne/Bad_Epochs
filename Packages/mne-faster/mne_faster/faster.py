...
def find_bad_components(
    ...
    return_by_metric : bool
        ...
        by this metric as values.
    proxy_name : str
        The name of the channel to use for EOG peak detection. The argument is mandatory
        if the dataset contains no EOG channels.
    ...
    metrics = {
        "eog_correlation": lambda x: x.find_bads_eog(epochs, ch_name=proxy_name)[1],
